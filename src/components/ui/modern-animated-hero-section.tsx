...
const ScrambledTitle: React.FC = () => {
  ...
  return (
    <h1
      ...
      style={{ fontFamily: "'Caveat', cursive", fontSize: 'clamp(48px, 8vw, 80px)' }}
    >
      Interview Prep Hub
    </h1>
  )
...
export function RainingLettersHero() {
  ...
  return (
    <div className="relative w-full bg-black overflow-hidden" style={{ height: '70vh' }}>
      {/* Title */}
...
export default RainingLettersHero
